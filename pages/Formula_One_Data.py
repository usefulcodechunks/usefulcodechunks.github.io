...
def session_selector():
    ...
    if step_completed("driver"):
        ...
        with view_data.expander(driver):
            ...
            st.write(temp_df[temp_df["LapNumber"]==selected_lap])

            plot_x_y(temp_df[temp_df["LapNumber"]==selected_lap].get_telemetry(),"X","Y","Speed","sector",second_cols[1],meta_dict_for_sectors)
            plot_x_y(temp_df[temp_df["LapNumber"]==selected_lap].get_telemetry(),"X","Y","sector","sector",second_cols[1],meta_dict_for_sectors)
